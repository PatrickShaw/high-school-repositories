...
Public Class frmSnake
    ...
    Private Sub tmrGame_Tick()
            ...
            For o As Long = 0 To snakeList.Count - 1
                ...
                For q As Long = 0 To snakeList(o).snakeBlocks.Count - 1
                    ...
                    If snakeList(i).snakeBlocks.First.coord = snakeList(o).snakeBlocks(q).coord Then
                        If snakeList(o).dead = False Then snakeList(o).IncreaseScore(40)
                        snakeList(i).Kill()
                    End If
                Next
            Next
        ...
        If singlePlayer Then
            If snakeList.Count <= numberDead Then
                GameEnd()
                t = 0
            End If
        Else
            If numberDead = snakeList.Count Then
                GameEnd(True)
                t = 0
            End If
            If numberDead = snakeList.Count - 1 Then
                GameEnd()
                t = 0
            End If
        End If
        If t > swek Then
            ...
            For i As Long = 0 To snakeList.Count - 1
                If snakeList(i).usingNN = False Then Kill = False
            Next
            For i As Integer = 0 To snakeList.Count - 1
                If Kill = False Then Continue For
                snakeList(i).Kill()
            Next
        End If
        If tmrGame.IsEnabled = False Then btnStart_Click(Nothing, Nothing)
    End Sub
