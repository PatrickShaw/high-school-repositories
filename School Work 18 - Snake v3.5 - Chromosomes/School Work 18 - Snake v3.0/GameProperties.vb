...
Public Module GameProperties
    ...
    Public experimentalPowers = False
    Public gameScores As TextBlock()
    Public matchesWon As TextBlock()
    Public firstGame As Boolean = True
    Public singlePlayer
    Public isTeamsEnabled As Boolean = False
    Public gameWindowOpened As Boolean = False

    Const gridWidth_DEFAULT = 30
    Const gridHeight_DEFAULT = 30
    ...
    Public GameCanvasPublic As Canvas
