...
Public Class Main_Window
    Sub New()
        ...
        btnStudentManager_Click(Nothing, Nothing)
    ...
    Private Sub btnStudentManager_Click(sender As Object, e As RoutedEventArgs) Handles btnStudentManager.Click
        Dim studentManager As Student_Manager = New Student_Manager()
        tbcModules.AddTab(studentManager, "Student Manager", False)
    End Sub
End Class
