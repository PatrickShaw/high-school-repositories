...
Public Class ctrOneOffSession
    Sub New()
        ...
        For Each Student In studentList
            ...
            lstStudents.Items.Add(Student.FullName())
        Next
        For Each Instructor In instructorList
            lstInstructor.Items.Add(Instructor.FullName())
        Next
    End Sub
    ...
    Private Sub btnOkay_Click(ByVal sender As Object, ByVal e As RoutedEventArgs) Handles btnOkay.Click
        ...
        For i As Long = 0 To instructorList.Count - 1
            If instructorList(i).FullName = lstInstructor.SelectedItem Then sessTemp.instructor = instructorList(i)
        Next
        For i As Long = 0 To studentList.Count - 1
            For o As Long = 0 To lstStudents.SelectedItems.Count - 1
                If studentList(i).FullName = lstStudents.SelectedItems(o) Then sessTemp.students.Add(studentList(i))
            Next
        Next
